...
public class UserRepositoryImpl implements UserRepository {
    ...
    @Override
    public Integer create(String firstName, String lastName, String email, String password) throws EtAuthExpcetion {
        ...
        try {
            ...
            throw new EtAuthExpcetion("Invalid details. Failed to create account");
        }
    }

    @Override
    public User findByEmailAndPassword(String email, String password) throws EtAuthExpcetion {
        try {
            User user = jdbcTemplate.queryForObject(SQL_FIND_BY_EMAIL, new Object[]{email}, userRowMapper);
            if (!BCrypt.checkpw(password, user.getPassword()))
                throw new EtAuthExpcetion("Invalid email/password");
            return user;
        } catch (Exception e) {
            throw new EtAuthExpcetion("Invalid email/password");
        }
